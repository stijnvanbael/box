...
const generatedInt = -1;

/// Metadata that indicates a field is a primary key.
class Key {
  final bool autogenerated;

  const Key({this.autogenerated = false});
}
...
abstract class EntitySupport<T> {
  ...
  final List<String> autogeneratedKeys;
  final String name;
  Registry? registry;
  ...
  EntitySupport({
    ...
    required this.autogeneratedKeys,
  ...
  bool isAutogenerated(String field) => autogeneratedKeys.contains(field);
}
